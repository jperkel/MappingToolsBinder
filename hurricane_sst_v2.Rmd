...
irmaPolygon <- readOGR(dsn=paste(base_path, irma_dir, sep=""), layer="al112017-020_5day_pgn")
irmaLine <- readOGR(dsn=paste(base_path, irma_dir, sep=""), layer = "al112017-020_5day_lin")
irmaPoints <- readOGR(dsn=paste(base_path, irma_dir, sep=""), layer="al112017-020_5day_pts")
```
...
ssts = extractOISSTdaily(paste(base_path, "sst.day.mean.2017.nc", sep = ""), paste(base_path, "lsmask.oisst.v2.nc", sep = ""), lonW=160, lonE=359, latS=-10, latN=60, date1='2017-09-04', date2='2017-09-05')
...
irmaPolygon <- geojson_read(paste (base_path, "irma_pgn.json", sep = ""), what = "sp")
irmaLine <- geojson_read(paste (base_path, "irma_lin.json", sep = ""), what = "sp")
irmaPoints <- geojson_read(paste (base_path, "irma_pts.json", sep = ""), what = "sp")
